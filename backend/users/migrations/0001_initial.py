    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Имя уже занято'}, help_text='Не более 150 символов. Только буквы латиницы, цифры и @/./+/-/_.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), django.core.validators.RegexValidator(flags=re.RegexFlag['IGNORECASE'], message='Нельзя использовать имя "me"', regex='^(?!me$).*')], verbose_name='Имя пользователя')),
                ('email', models.EmailField(error_messages={'unique': 'Для этой почты уже есть аккаунт'}, max_length=254, unique=True, verbose_name='Эл. почта')),
                ('first_name', models.CharField(max_length=150, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=150, verbose_name='Фамилмя')),
